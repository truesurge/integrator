...
| --- | --- |
| ⚠️ Отключите мосфеты заряда/разряда в приложении. ⚠️<br><img src="img/jbd_app_fets.jpg" width="200" alt="BMS app fets"> | ⚠️ Отключите мосфеты заряда/разряда в приложении. ⚠️<br><img src="img/jbd_app_fets.jpg" width="200" alt="BMS app fets"> |
| Подключите интегратор к BMS: 4-контактный разъём → порт UART. | Подключите интегратор к BMS: 4-контактный разъём → порт UART. |
| Подключите интегратор к MCU: 4-контактный разъём Molex minifit. | Подключите интегратор к MCU: 4-контактный разъём Molex minifit. |
| Подключите интегратор к MCU разъёмом XT90. | Подключите аккумулятор напрямую к MCU|
| Подключите аккумулятор к интегратору разъёмом XT90. | Включите мосфеты заряда/разряда в приложении. |
| Включите мосфеты заряда/разряда в приложении. | — |
